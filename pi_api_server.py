...
def on_message(client, userdata, msg):
    """ONLY CHANGE: Add requestId to response"""
    try:
        payload = json.loads(msg.payload.decode())
        fn = payload.get("functionName")
        args = payload.get("args", [{}])
        request_id = payload.get("requestId")  # Get requestId if present
        ...
        # Add requestId to response if it was in the request
        if request_id:
        ...
        # Include requestId in error too
